  ...
  >
    ...
    <div className="group relative">
      ...
      <input id={id} type={type} value={value} onChange={onChange} placeholder={placeholder}
        ...
        style={{ background: "rgba(var(--theme-white),0.04)", backdropFilter: "blur(30px)", WebkitBackdropFilter: "blur(30px)", borderColor: "rgba(var(--theme-white),0.07)", boxShadow: "inset 0 1px 0 rgba(var(--theme-white),0.05), 0 2px 12px rgba(var(--theme-black),0.25)" }}
