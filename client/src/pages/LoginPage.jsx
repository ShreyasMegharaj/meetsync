        ...
        >
          ...
          <div className="relative" style={{ zIndex: 3 }}>
            ...
            <form onSubmit={submit} className="mt-8 space-y-5">
              <GlassInput id="email" label="Email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" d={0.5}
                icon={<svg className="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.4}><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>} />
              ...
              <GlassInput id="password" label="Password" type={showPw ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" d={0.6}
                ...
                extra={
                  <button type="button" onClick={() => setShowPw(!showPw)} className="absolute inset-y-0 right-0 flex items-center pr-4 text-white/15 hover:text-white/40 transition-colors duration-300" tabIndex={-1} style={{ cursor: "none" }}>
                    {showPw ? (
                      ...
                      <svg className="h-[18px] w-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.4}><path strokeLinecap="round" strokeLinejoin="round" d="M1 12s4-7.5 11-7.5S23 12 23 12s-4 7.5-11 7.5S1 12 1 12z" /><circle cx="12" cy="12" r="3" /></svg>
                    )}
                  </button>
                } />
              ...
              <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7, duration: 0.7 }}>
                <motion.button type="submit" disabled={loading}
                  ...
                  {loading ? (
                    <><Spinner /><span className="relative">Signing in…</span></>
                  ) : (
            ...
            <motion.p className="mt-6 text-center text-sm text-white/20"
              ...
              <Link to="/register" className="font-semibold text-white/40 transition-all duration-300 hover:text-white/70"
                style={{ cursor: "none" }}
